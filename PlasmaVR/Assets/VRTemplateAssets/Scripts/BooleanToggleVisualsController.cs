...
#pragma warning restore 649
        ...
        void ToggleValueChanged(bool value)
        {
            ...
            float targetX = value ? k_TargetPositionX : -k_TargetPositionX;
            Vector3 oldPosition = m_Knob.localPosition;
            m_Knob.localPosition = new Vector3(targetX, oldPosition.y, oldPosition.z);
        }
